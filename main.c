...
main() {
	...
	GPIO_INIT_INPUT_PULLUP(GPIOA, GPIO_PIN_1 | GPIO_PIN_2);
	GPIO_IT_ENABLE(GPIOA, GPIO_PIN_1 | GPIO_PIN_2);
	GPIO_INIT_INPUT_PULLUP(GPIOC, GPIO_PIN_3 | GPIO_PIN_7);
	GPIO_IT_ENABLE(GPIOC, GPIO_PIN_3 | GPIO_PIN_7);
